...
async def firsat_tarayici():
    ...
    def tara():
        ...
        for ticker in BIST100:
            ...
            if r:
                sonuclar.append(r)
        # Skora göre sırala, eşitlerde RSI dip olanlar önce
...
async def para_akisi():
    ...
    def tara():
        sonuclar = []
        for ticker in BIST100:
            r = hisse_para_akisi(ticker)
            if r:
                sonuclar.append(r)
        # Para akış skoruna göre sırala
...
async def zanger_tarayici():
    ...
    def zanger_hesapla(ticker: str, bist100_getiri: float) -> dict | None:
        try:
            ...
            zirve_52h = float(np.max(yuksek[-252:]))
    ...
    def tara():
        ...
        sonuclar = []
        for ticker in BIST100:
            r = zanger_hesapla(ticker, bist_getiri)
            if r:
                sonuclar.append(r)

        # Skora göre sırala, eşitlerde RS skoru
